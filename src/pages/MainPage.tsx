...
const MainPage = () => {
  ...
  const featuredBikes = [
    ...
    },
    {
      ...
      image: 'https://htcms-prod-images.s3.ap-south-1.amazonaws.com/htmobile1/bajaj_pulsar220f/images/colours_bajaj-pulsar-220f_black-silver_600x400.jpg',
      rating: 4.3,
      category: 'popular',
      mileage: '40 km/l',
      fuelType: 'Petrol',
      tankCapacity: '15 liters',
      engine: '220cc, Air Cooled, 4-Stroke, SI Engine',
      brakes: 'Disc brakes (Front & Rear)',
      transmission: '5-Speed Manual',
      launchDate: '2022-03-15',
      topSpeed: '130 km/h',
      acceleration: '6.2 seconds',
      power: '20.5 bhp @ 8,500 rpm',
      torque: '18.5 Nm @ 7,000 rpm',
      seatingCapacity: 'Dual seat',
      weight: '165 kg',
      length: '2050 mm',
      width: '780 mm',
      ...
      lights: 'LED headlights and taillights',
      comfort: 'Comfortable riding position, wide seat',
      compatibility: 'Ideal for city commuting and weekend rides',
      usedKms: 'N/A',
      yearsUsed: 'New Launch',
      condition: 'Brand New',
      toolKit: 'Available',
    ...
    {
      id: 11,
      name: 'Bajaj Discovery',
      price: '₹95,000',
      originalPrice: '₹1.05 Lakh',
      image: 'https://cdn.bikedekho.com/processedimages/bajaj/bajaj-discover-100/source/m_bajaj-discover-100_2.jpg?imwidth=880',
      rating: 4.1,
      category: 'popular',
      mileage: '65 km/l',
      fuelType: 'Petrol',
      tankCapacity: '10 liters',
      engine: '100cc, Air Cooled, 4-Stroke, SI Engine',
      brakes: 'Drum brake (Front & Rear)',
      transmission: '4-Speed Manual',
      launchDate: '2021-11-20',
      topSpeed: '85 km/h',
      acceleration: '9.5 seconds',
      power: '7.8 bhp @ 7,500 rpm',
      torque: '8.05 Nm @ 6,500 rpm',
      seatingCapacity: 'Single seat',
      weight: '115 kg',
      length: '1900 mm',
      width: '720 mm',
      height: '1080 mm',
      lights: 'Halogen headlight and taillight',
      comfort: 'Ergonomic design, lightweight',
      compatibility: 'Best for short city commutes and college students',
      usedKms: 'N/A',
      yearsUsed: 'New Launch',
      condition: 'Brand New',
      toolKit: 'Available',
      ...
      salesCount: 'N/A',
      reviews: 'N/A',
      offers: 'Free first service, 1 year warranty'
    },
    {
      id: 12,
      name: 'Unicorn',
      ...
      image: 'https://imgd.aeplcdn.com/1280x720/n/cw/ec/1/versions/--disc-20251735194316753.jpg',
      rating: 4.4,
      category: 'popular',
      mileage: '55 km/l',
      fuelType: 'Petrol',
      tankCapacity: '13 liters',
      engine: '162.7cc, Air Cooled, 4-Stroke, SI Engine',
      brakes: 'Disc brake (Front), Drum brake (Rear)',
      transmission: '5-Speed Manual',
      launchDate: '2023-01-10',
      topSpeed: '110 km/h',
      acceleration: '7.8 seconds',
      power: '12.8 bhp @ 8,500 rpm',
      torque: '14.1 Nm @ 6,500 rpm',
      seatingCapacity: 'Dual seat',
      weight: '145 kg',
      length: '2020 mm',
      width: '750 mm',
  ...
  const scooters = [
    ...
    },
    {
      ...
      image: 'https://img.autocarpro.in/autocarpro/890bd43a-1c5b-4d3d-8468-660e9934596b.jpg?w=750&h=490&q=75&c=1',
      rating: 4.2,
      category: 'popular',
      mileage: '48 km/l',
      fuelType: 'Petrol',
    ...
    },
    {
      ...
      image: 'https://www.otocapital.in/_next/image?url=https%3A%2F%2Fassets.otocapital.in%2Fprod%2Factive-matte-grey-and-blue-hero-maestro-right-side-view.webp&w=1536&q=75',
      rating: 4.2,
      category: 'popular',
      mileage: '52 km/l',
      fuelType: 'Petrol',
      tankCapacity: '6.5 liters',
      engine: '110cc, Air Cooled, 4-Stroke, SI Engine',
      brakes: 'Disc brake (Front), Drum brake (Rear)',
      transmission: 'CVT Automatic',
    ...
    },
    {
      ...
      price: '₹72,000',
      originalPrice: '₹78,000',
      image: 'https://5.imimg.com/data5/PP/EC/MY-30249099/tvs-pep-plus-87-8-cc-scooty-500x500.jpg',
      rating: 4.0,
      category: 'popular',
      mileage: '58 km/l',
      fuelType: 'Petrol',
      tankCapacity: '5.2 liters',
      engine: '87.8cc, Air Cooled, 4-Stroke, SI Engine',
      brakes: 'Drum brake (Front & Rear)',
      transmission: 'CVT Automatic',
      launchDate: '2021-12-10',
      topSpeed: '75 km/h',
      acceleration: '9.8 seconds',
      power: '6.2 bhp @ 7,000 rpm',
      torque: '7.1 Nm @ 5,000 rpm',
      seatingCapacity: 'Dual seat',
      weight: '95 kg',
      length: '1780 mm',
      width: '680 mm',
      height: '1140 mm',
      lights: 'LED headlights and taillights',
      comfort: 'Comfortable riding position, compact design',
      compatibility: 'Best for short city commutes and college students',
      usedKms: 'N/A',
      yearsUsed: 'New Launch',
      condition: 'Brand New',
    ...
    },
    {
      ...
      name: 'TVS Ntorq',
      price: '₹95,000',
      originalPrice: '₹1.02 Lakh',
      image: 'https://cdn.bikedekho.com/processedimages/tvs/ntorq-125/source/ntorq-12568a8080b61608.jpg',
      rating: 4.5,
      category: 'popular',
      mileage: '42 km/l',
      fuelType: 'Petrol',
      ...
      lights: 'LED headlights and taillights',
      comfort: 'Comfortable riding position, wide seat',
      compatibility: 'Perfect for city commuting and short trips',
      usedKms: 'N/A',
      yearsUsed: 'New Launch',
      condition: 'Brand New',
      toolKit: 'Available',
      ...
      <main className="lg:ml-0 pt-4 pb-6 flex-grow">
        <div className="max-w-8xl mx-auto px-4">
          ...
          <motion.div
            ...
            className="bg-white rounded-lg shadow-md p-4 mb-6"
          >
            <h3 className="text-xl font-bold text-gray-800 mb-4 bg-yellow-100 inline-block px-4 py-2 rounded-lg border-l-4 border-yellow-500">Featured Bikes</h3>
            
            {/* Bikes Scrollable Container */}
          ...
          <motion.div
            ...
            className="bg-white rounded-lg shadow-md p-4 mb-6"
          >
            <h3 className="text-xl font-bold text-gray-800 mb-4 bg-yellow-100 inline-block px-4 py-2 rounded-lg border-l-4 border-yellow-500">Featured Scooty</h3>
            
            {/* Scooters Scrollable Container */}
            <div className="overflow-x-auto pb-4">
              <div className="flex space-x-6 min-w-max">
          ...
          <motion.div
            ...
            className="bg-white rounded-lg shadow-md p-4 mb-6"
          >
            <h3 className="text-xl font-bold text-gray-800 mb-4 bg-green-100 inline-block px-4 py-2 rounded-lg border-l-4 border-green-500">Upcoming Bikes</h3>
          ...
          <motion.div
            ...
            className="bg-white rounded-lg shadow-md p-4 mb-6"
          >
            <h3 className="text-xl font-bold text-gray-800 mb-4 bg-green-100 inline-block px-4 py-2 rounded-lg border-l-4 border-green-500">Upcoming Scooty</h3>
